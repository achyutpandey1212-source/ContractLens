...
export const AboutUs: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-lausanne selection:bg-[#D3FD50] selection:text-black">
      ...
      <header className="border-b border-black sticky top-0 z-40 bg-white/95 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="text-[11px] tracking-[0.16em] uppercase px-4 py-2 bg-black text-white hover:bg-[#D3FD50] hover:text-black transition-colors cursor-pointer"
            >
              START USING →
            </button>
          </div>
